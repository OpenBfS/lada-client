 ...
 */
Ext.define('Lada.view.widget.base.IntegerRange', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.intrangefield',
    ...
    initComponent: function() {
        ...
        var fromField = Ext.create(
            'Lada.view.form.FormatNumberField', numberOptions);

        numberOptions.name = this.name + 'To';
        numberOptions.fieldLabel = i18n.getMsg('to');
        numberOptions.margin = '5 0 5 5';
        var toField = Ext.create('Lada.view.form.FormatNumberField',
            numberOptions);
